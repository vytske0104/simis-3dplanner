...
export  function MatObject(menu, fun) {  
  ...
  /*  this.mResurs=new MResurs(this.content, this.widthBig*2+this.otstup*4, -32, function(s, p){      
    ...
    this.start= function(){ 
        ...
        trace("@@@start@@",self.object.id,self.object.key,self.object.obj.type,self.object)
        ...
        trace("@@@start1@@",self.object.id,self.object.key,self.object.obj.type,self.object)
        //this.index=0;
        trace("@@@start2@@",self.object.id,self.object.key,self.object.obj.type,self.object)
        ...
        this.korektIndex(this.object.key)
        this.korekt.objOld=undefined

        trace("@@@start3@@",self.object.id,self.object.key,self.object.obj.type,self.object)
    ...
    this.korektIndex=function(s){  
        
        var p=-1;
        for (var i = 0; i < this.korekt.array.length; i++) {
             
            if(this.korekt.array[i].name==s){
