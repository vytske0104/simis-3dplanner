...
MVisi3D.prototype = {
	...
	set rotationX (v) {
		...
		this.utility.pointZdvig.set("rotationX",v,this._rotationX)
		this._rotationX = v;
		this.intRend = 1;
	...
	set rotationZ (v) {
		...
		this.utility.pointZdvig.set("rotationZ",v,this._rotationZ)
		this._rotationZ = v;
	...
	set zume (v) {
		...
		this.utility.pointZdvig.set("zume",v,this._zume)
